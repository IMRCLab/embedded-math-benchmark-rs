...
#let infrastructure-panel() = block(width: 100%)[
  ...
  #grid(
    ...
    column-gutter: 34pt,
    stat-block("18 math primitives", [Tested against various inputs. Baked into flash at compile time]),
    stat-block("6 libraries", [glam, nalgebra, micromath, Rust libm vs. CMSIS-DSP and cmath3d]),
