...
<div style="display: flex; justify-content: space-between; font-size: 0.6em; gap: 20px;">
<div style="width: 48%;">

**`nalgebra` (Static Matrix Unrolling)**
- Matrix sizes known at compile-time ($9 \times 9$)
- 100% pure math, **NO** loop overhead
- 988 consecutive FPU instructions
...
- C structs containing `numRows`, `numCols`, `*pData`
- 4 pipeline-stalling instructions for every 1 math op
...
.L_inner_loop:
    ...
    adds    r5, r5, r8   // OVERHEAD
    adds    r4, r4, #4   // OVERHEAD
    subs    r6, r6, #1   // OVERHEAD
    cmp     r6, #0       // OVERHEAD
    bne     .L_inner_loop// OVERHEAD
```
</div>
</div>
